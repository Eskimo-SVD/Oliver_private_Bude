...
*
*
*            Speicherort : erst Datei später MySQL oder MariaDB
*            Datenbank   : Metabolic
...
// Start der Eingaben
    ...
    cout << "Geben Sie Ihre Körpergröße (in cm) ein : " ;
...
// Darstellung der Eingaben
    ...
    cout << "Körpergröße         : " << V_Koerpergroesse << endl;
...
// Berechnung für das Geschlecht

/* Männer Grundumsatz = 66,47 + (13,7 x V_Gewicht) + (5 x V_Koerpergroesse) - (6,8 x V_Alter)
...
// Schreiben der Werte in die Datei
    ...
    f << "Name                  : " << V_Namen << endl;
    f << "Körpergröße           : " << V_Koerpergroesse << endl;
    f << "Gewicht               : " << V_Gewicht << endl;
//    f << "Männlich            : " << V_Maennlich << endl;
