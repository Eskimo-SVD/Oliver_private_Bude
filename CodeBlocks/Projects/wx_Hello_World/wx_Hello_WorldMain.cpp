...
BEGIN_EVENT_TABLE(wx_Hello_WorldDialog, wxDialog)
    EVT_CLOSE(wx_Hello_WorldDialog::OnClose)
    EVT_BUTTON(idBtnQuit, wx_Hello_WorldDialog::OnQuit)
    EVT_BUTTON(idBtnAbout, wx_Hello_WorldDialog::OnAbout)
END_EVENT_TABLE()

wx_Hello_WorldDialog::wx_Hello_WorldDialog(wxDialog *dlg, const wxString &title)
...
wx_Hello_WorldDialog::~wx_Hello_WorldDialog()
{
}

void wx_Hello_WorldDialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void wx_Hello_WorldDialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void wx_Hello_WorldDialog::OnAbout(wxCommandEvent &event)
{
