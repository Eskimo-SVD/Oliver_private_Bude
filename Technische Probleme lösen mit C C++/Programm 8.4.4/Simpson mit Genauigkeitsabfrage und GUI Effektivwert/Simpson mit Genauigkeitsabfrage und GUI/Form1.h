...
namespace SimpsonmitGenauigkeitsabfrageundGUI {
	...
	private: System::Windows::Forms::TextBox^  tB_ieff;

	private: System::Windows::Forms::Label^  lb_n;
	private: System::Windows::Forms::Label^  lb_ieff;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->tB_ieff = (gcnew System::Windows::Forms::TextBox());
			this->lb_n = (gcnew System::Windows::Forms::Label());
			this->lb_ieff = (gcnew System::Windows::Forms::Label());
			...
			this->gB_Ergebnis->Controls->Add(this->tB_ieff);
			this->gB_Ergebnis->Controls->Add(this->lb_n);
			this->gB_Ergebnis->Controls->Add(this->lb_ieff);
			...
			// tB_ieff
			// 
			this->tB_ieff->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->tB_ieff->Location = System::Drawing::Point(161, 30);
			this->tB_ieff->Name = L"tB_ieff";
			this->tB_ieff->ReadOnly = true;
			this->tB_ieff->Size = System::Drawing::Size(150, 26);
			this->tB_ieff->TabIndex = 2;
			// 
			// lb_n
			// 
			...
			// lb_ieff
			// 
			this->lb_ieff->AutoSize = true;
			this->lb_ieff->Font = (gcnew System::Drawing::Font(L"Comic Sans MS", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->lb_ieff->Location = System::Drawing::Point(20, 34);
			this->lb_ieff->Name = L"lb_ieff";
			this->lb_ieff->Size = System::Drawing::Size(87, 18);
			this->lb_ieff->TabIndex = 0;
			this->lb_ieff->Text = L"Effektivwert";
			// 
			// gB_f
			// 
...
#pragma endregion
   ...
   private: System::Void bt_rechne_Click(System::Object^  sender, System::EventArgs^  e) 
   {
	  ...
	  do
	  {
	     ...
	     aN   = delta_x / 3. * s;
		 ieff = sqrt(1./(2.*M_PI)*aN);
      }while ( abs( aA - aN ) > epsilon);
	  // Ergebnisse anzeigen
	  this->tB_n->Text    = System::Convert::ToString(n);
	  this->tB_ieff->Text = System::Convert::ToString(ieff);
   }
   // Funktion f(x)
